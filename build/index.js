...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/interactivity-quiz","version":"0.1.0","title":"Interactivity Quiz","category":"widgets","icon":"media-interactive","description":"An interactive block with the Interactivity API.","example":{},"supports":{"interactivity":true},"textdomain":"interactivity-quiz","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScriptModule":"file:./view.js","attributes":{"question":{"type":"string"},"answers":{"type":"array","default":[{"name":""}]},"correctAnswer":{"type":"string","default":null},"bgColor":{"type":"string","default":"#EBEBEB"},"theAlign":{"type":"string","default":"left"}}}');
